...
<body>
	...
	<%
		sql = "select nvl(max(CUSTNO),0)+1, to_char(sysdate,'yyyy-mm-dd') from member_tbl";
		...
		<form action="insertPro.jsp" method="post" name="f">
			<table border="1" width="700" style="margin: 0 auto;">
				...
				<tr>
					...
					<td>
						<input type="text" name="CUSTNAME" value="" size="30">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="JOINDATE" value="<%=rs.getString(2)%>" size="30" readonly>
					</td>
				</tr>
				<tr>
					<th bgcolor="yellow">고객등급[A:VIP, B:일반 , C:직원]</th>
					<td>
						<input type="text" name="GRADE" value="" size="30" maxlength="1">
					</td>
				</tr>
				<tr>
					<th style="background-color: yellow;">거주도시</th>
					<td>
						<input type="text" name="CITY" value="" size="30" maxlength="2">숫자 두자리 입력 ex).20
					</td>
				</tr>
			</table>
			<br>
