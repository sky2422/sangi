...
<body>
	...
	<%
	sql = "select NVL(max(custno),100000)+1 AS custno from member_tbl_02";
		...
		<form action="insertPro.jsp" name="f" method="post">
			<table style="margin:0 auto" border="1" width="600">
				...
				<tr>
					<th>가입일자</th>
					<td>
						<input type="text" name="joindate" value="<%=joindate%>" size="10" maxlength="" readonly>
					</td>
				</tr>
				<tr>
